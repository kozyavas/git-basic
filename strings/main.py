...
player=scorer_1
first_name=player[:4]
find_first_name=player.find("Ruud")
print(first_name)


find_last_name=scorer_1.find("Gullit")
name_lenght=len(player)
slice_last_name= scorer_1[5:11]
last_name_len=len(slice_last_name)
last_name=scorer_1[find_last_name:name_lenght]
print(last_name)
